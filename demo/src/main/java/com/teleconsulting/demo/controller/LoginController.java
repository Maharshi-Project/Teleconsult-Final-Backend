...
//    }
    ...
    public ResponseEntity<?> docLogin(@RequestBody AuthenticationRequest request, HttpServletResponse response) {
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(request.getEmail(),request.getPassword());
        try{
            Authentication authentication = authenticationManager.authenticate(authenticationToken);
            if(authentication.isAuthenticated()) {
    ...
    public ResponseEntity<?> srDocLogin(@RequestBody AuthenticationRequest request, HttpServletResponse response) {
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(request.getEmail(),request.getPassword());
        try{
            System.out.println(authenticationToken.isAuthenticated());
            System.out.println("Authentication Token is "+authenticationToken);
