...
//                .cors(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/admin/**").hasAnyRole("ADMIN","SRDOC","DOCTOR","USER")
                        .requestMatchers("/doctor/**").hasAnyRole("ADMIN","SRDOC","DOCTOR","USER")
                        .requestMatchers("/patient/**").hasAnyRole("ADMIN","SRDOC","DOCTOR","USER")
                        .requestMatchers("/callhistory/**").permitAll()
